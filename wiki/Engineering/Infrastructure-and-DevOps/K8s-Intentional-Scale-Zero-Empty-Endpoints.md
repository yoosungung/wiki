...
sources:
  ...
  - inbox/ta/2026-09-17-k8s-daily-report.md
...
- **재확인 (2026-09-17)**: `didim-gpu` Ready·Disk/Memory/PIDPressure=False·CPU ~7%/mem ~42%(54Gi)·CrashLoop/ImagePull/Pending/Warning=0·Deploy/STS ready 일치·PVC Bound + postgres live 4Gi/2Gi·restarts 0. allowlist: `llm-serving/sglang-gemma4-12b` + `runtime/pgbouncer-{ro,rw}` scale-0. 활성 LLM `sglang-gemma4-31b` 1/1; path-graph filestash 1/1 + terminal Workflow CR만 잔존 → 위생(Incident 아님). 점검 worktree feature 브랜치 untracked → git pull 생략 기준선 유지.
