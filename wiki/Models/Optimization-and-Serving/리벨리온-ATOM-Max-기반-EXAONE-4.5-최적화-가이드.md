...
4.  **a7~a1 검증 항목**: a8 chunked prefill×spec; a9 MTP contiguous weights; a11 DP×MTP·w8a8 MoE·APC; **dev0 metrics_v2 · ATOM/REBEL prefill · vision overrides**; **a0/a1 dtensor default · DeepSeek MTP**.
